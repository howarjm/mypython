...
def read_words(words_file):
    ...
    flanders_file = open(words_file, 'r')
    flanders_words = ''

    for line in flanders_file:
        flanders_words = flanders_words + line

    return(flanders_words)
    flanders_file.close()
